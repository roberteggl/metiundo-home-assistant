...
## applyTo: "\*\*" name: "Commit Message Conventions" description: "Conventional Commits format for this Home Assistant integration project"
...
- Trim verbose commit format blocks from AGENTS.md; both now
