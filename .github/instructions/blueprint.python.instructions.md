...
script/type-check   # basedpyright — no auto-fix, always manual
```
...
- Look up error codes: [Ruff rules](https://docs.astral.sh/ruff/rules/), [basedpyright docs](https://docs.basedpyright.com/)
