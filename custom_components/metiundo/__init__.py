"""
Custom integration to integrate Metiundo with Home Assistant.

This integration provides access to your Metiundo smart meter data:
- Historical 15-minute meter readings (cumulative grid import/export)
- Energy Dashboard-compatible energy sensors (planned)
...
from .data import MetiundoData
from .service_actions import async_setup_services

if TYPE_CHECKING:
    from homeassistant.core import HomeAssistant

    from .data import MetiundoConfigEntry
...
async def async_setup_entry(
    ...
    # Store runtime data
    entry.runtime_data = MetiundoData(
        client=client,
