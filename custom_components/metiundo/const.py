...
CONF_ENABLE_COST_METRICS = "enable_cost_metrics"
CONF_ARBEITSPREIS_CT_PER_KWH = "arbeitspreis_ct_per_kwh"
CONF_GRUNDPREIS_EUR_PER_MONTH = "grundpreis_eur_per_month"
CONF_TARIFF_EFFECTIVE_FROM = "tariff_effective_from"
...
DEFAULT_ENABLE_COST_METRICS = False
DEFAULT_ARBEITSPREIS_CT_PER_KWH = 0.0
DEFAULT_GRUNDPREIS_EUR_PER_MONTH = 0.0
STATISTIC_GRID_IMPORT_COST = "grid_import_cost"
