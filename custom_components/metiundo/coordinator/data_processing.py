...
def validate_api_response(data: Any) -> bool:
    ...
    Example:
        >>> data = {"readings": [{"energyOut": 12345.67}]}
...
def transform_api_data(raw_data: Any) -> dict[str, Any]:
    ...
    Example:
        >>> raw = {"energyOut": 12345.67}
        >>> transform_api_data(raw)
        {"grid_import_kwh": 12345.67, "grid_import_15min_avg_power_kw": 49.38}
    """
...
def cache_computed_values(data: dict[str, Any]) -> dict[str, Any]:
    ...
    Example:
        >>> data = {"grid_import_kwh": 1000}
        >>> cache_computed_values(data)
        {"grid_import_kwh": 1000, "grid_export_kwh": 0.0}
    """
