"""
Core DataUpdateCoordinator implementation for metiundo.
...
from custom_components.metiundo.api import MetiundoApiClientAuthenticationError, MetiundoApiClientError
from custom_components.metiundo.const import LOGGER
...
class MetiundoDataUpdateCoordinator(DataUpdateCoordinator):
    """
            ...
            "readings": [
                {
                    ...
                    "energyOut": 12345.67,  # Cumulative grid import in kWh (OBIS 1.8.0)
                    "energyIn": 0.0,        # Cumulative grid export in kWh (OBIS 2.8.0)
